 ...
 */
exports.getTopContactsWithPersonalHistory = function(aOpts) {
  let contactLimit = 20;
 ...
 */
exports.getContactPersonalHistory = function(aContactOrIdentity, aOpts) {
 ...
 */
exports.getRecentConversations = function(aOpts) {
  throw new Error("not remotely implemented");
};
